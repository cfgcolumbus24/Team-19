    ...
    useEffect(() => {
        const fetchLessons = async () => {
            try {
                ...
                const uniqueLessons = Array.from(new Set(data.map(lesson => lesson.lesson_number)))
                    .map(lesson_number => ({
                        lesson_number,
                        // Sum likes for all versions of this lesson
                        likes: data.filter(l => l.lesson_number === lesson_number)
        ...
        <div className="subject-page">
            ...
            <div className="subject-header">
                ...
                <div className="lesson-count">
                    Total Unique Lessons: {lessonCount}
                </div>
            </div>
            <div className="lessons-grid">
                {lessons.map((lesson) => (
                    <Link 
                        ...
                        to={`/lesson/${subject}/${lesson.lesson_number}`}
